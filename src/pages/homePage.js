...
const Home = () => {
  ...
  return (
          ...
          <div className="flex items-center">
            ...
            <div class="flex flex-row px-2 mx-3">
                ...
                <div class="flex flex-col mb-2 ml-4 mt-1">
                    <div class="text-gray-600 text-sm font-semibold">{user?.user?.firstName || 'Nina'} {user?.user?.lastName || 'Karlina'}</div>
                </div>
            </div>
    ...
    <div className="flex overflow-hidden bg-white pt-16">
      <div id="sidebar" className="fixed hidden z-20 h-full top-0 left-0 pt-16 lg:flex flex-shrink-0 flex-col w-64 transition-width duration-75" aria-label="Sidebar">
          ...
          <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
            <div className="flex-1 px-3 bg-white divide-y space-y-1">
              <ul className="space-y-2 pb-2">
                ...
                <li>
                  <div href="#" className="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
                ...
                <li>
                  <div href="#" target="_blank" className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                ...
                <li>
                  <div href="#" className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                    <svg className="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="space-y-2 pt-2">
                <div href="#" className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 group transition duration-75 flex items-center p-2">
                ...
                <div href="#" target="_blank" className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 group transition duration-75 flex items-center p-2">
                  <svg className="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
      ...
      <div id="main-content" className="h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-64">
            ...
            <div className="w-full grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4">
              ...
              <div className="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                <div className="mb-4 flex items-center justify-between">
                  ...
                  <div className="flex-shrink-0">
                    <div href="#" className="text-sm font-medium text-cyan-600 hover:bg-gray-100 rounded-lg p-2">View all</div>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 2xl:grid-cols-2 xl:gap-4 my-4">
              <div className="bg-white shadow rounded-lg mb-4 p-4 sm:p-6 h-full">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div href="#" className="text-sm font-medium text-cyan-600 hover:bg-gray-100 rounded-lg inline-flex items-center p-2">
                    View all
                  </div>
                </div>
                <div className="flow-root">
                  <ul className="divide-y divide-gray-200">
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm text-gray-500 truncate">
                            <div href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="17727a767e7b57607e7973646372653974787a">[email&nbsp;protected]</div>
                          </p>
                        </div>
                    ...
                    <li className="py-3 sm:py-4">
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm text-gray-500 truncate">
                            <div href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="d4b1b9b5bdb894a3bdbab0a7a0b1a6fab7bbb9">[email&nbsp;protected]</div>
                          </p>
                        </div>
                        <div className="inline-flex items-center text-base font-semibold text-gray-900">
                          $3467
                    ...
                    <li className="py-3 sm:py-4">
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm text-gray-500 truncate">
                            <div href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="57323a363e3b17203e3933242332257934383a">[email&nbsp;protected]</div>
                          </p>
                        </div>
                        <div className="inline-flex items-center text-base font-semibold text-gray-900">
                          $67
                    ...
                    <li className="py-3 sm:py-4">
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm text-gray-500 truncate">
                            <div href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="284d45494144685f41464c5b5c4d5a064b4745">[email&nbsp;protected]</div>
                          </p>
                        </div>
                        <div className="inline-flex items-center text-base font-semibold text-gray-900">
                          $2367
                    ...
                    <li className="pt-3 sm:pt-4 pb-0">
                      <div className="flex items-center space-x-4">
                        <div className="flex-shrink-0">
                          <img alt="data" className="h-8 w-8 rounded-full" src="https://demo.themesberg.com/windster/images/users/lana-byrd.png" />
                        </div>
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-medium text-gray-900 truncate">
                            Lana Byrd
                          ...
                          <p className="text-sm text-gray-500 truncate">
                            <div href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="a2c7cfc3cbcee2d5cbccc6d1d6c7d08cc1cdcf">[email&nbsp;protected]</div>
                          </p>
                        </div>
                        <div className="inline-flex items-center text-base font-semibold text-gray-900">
                          $367
                          ...
                          <div className="flex items-center">
                            ...
                            <div className="relative w-full">
                              <div className="w-full bg-gray-200 rounded-sm h-2">
                                <div className="bg-cyan-600 h-2 rounded-sm" stylename="width: 30%" />
                              </div>
                            </div>
                          </div>
                        </td>
        ...
        <footer className="bg-white md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4">
          <ul className="flex items-center flex-wrap mb-6 md:mb-0">
            <li><div href="#" className="text-sm font-normal text-gray-500 hover:underline mr-4 md:mr-6">Terms and conditions</div></li>
            <li><div href="#" className="text-sm font-normal text-gray-500 hover:underline mr-4 md:mr-6">Privacy Policy</div></li>
            <li><div href="#" className="text-sm font-normal text-gray-500 hover:underline mr-4 md:mr-6">Licensing</div></li>
            <li><div href="#" className="text-sm font-normal text-gray-500 hover:underline mr-4 md:mr-6">Cookie Policy</div></li>
            <li><div href="#" className="text-sm font-normal text-gray-500 hover:underline">Contact</div></li>
          </ul>
          <div className="flex sm:justify-center space-x-6">
            <div href="#" className="text-gray-500 hover:text-gray-900">
        ...
        <p className="text-center text-sm text-gray-500 my-10">
          <div href="#" className="hover:underline" target="_blank"> ©2023 Ridwan Maulana All rights reserved.</div>
        </p>
      </div>
    </div>
  </div>
